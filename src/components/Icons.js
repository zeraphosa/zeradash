function DashboardIcon({ size }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path opacity="0.1" d="M8.976 3C4.05476 3 3 4.05476 3 8.976V15.024C3 19.9452 4.05476 21 8.976 21H9V9H21V8.976C21 4.05476 19.9452 3 15.024 3H8.976Z" fill="none" />
...
function FlagUsaIcon({ size }) {
  return (
    <svg width={size} height={size} viewBox="0 -4 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function WeatherCloudy({ size }) {
  return (
    <svg fill="currentColor" width={size} height={size} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 384">
      <g>
        <g>
          <path
            d="M280,125.672c-4.32,0-8.632,0.264-12.896,0.784C253.592,85.328,213.64,56,168,56c-57.344,0-104,45.376-104,101.16
...
function WeatherFoggy({ size }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <g id="Layer_1" />
      <g id="Layer_2">
        <g>
...
function WeatherRainy({ size }) {
  return (
    <svg width={size} height={size} fill="currentColor" version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64">
      <g>
        <path
          d="M23.414,44.586c-0.781-0.781-2.047-0.781-2.828,0l-6,6c-0.781,0.781-0.781,2.047,0,2.828C14.977,53.805,15.488,54,16,54
		s1.023-0.195,1.414-0.586l6-6C24.195,46.633,24.195,45.367,23.414,44.586z"
        />
        <path
          d="M46.586,44.586l-8,8c-0.781,0.781-0.781,2.047,0,2.828C38.977,55.805,39.488,56,40,56s1.023-0.195,1.414-0.586l8-8
		c0.781-0.781,0.781-2.047,0-2.828C48.633,43.805,47.367,43.805,46.586,44.586z"
        />
        <path
          d="M33.586,44.586l-14,14c-0.781,0.781-0.781,2.047,0,2.828C19.977,61.805,20.488,62,21,62s1.023-0.195,1.414-0.586l14-14
		c0.781-0.781,0.781-2.047,0-2.828C35.633,43.805,34.367,43.805,33.586,44.586z"
        />
        <path
          d="M55.926,22.186C55,10.901,45.52,2,34,2C23.776,2,14.958,8.635,12.409,18H12C5.383,18,0,23.383,0,30s5.383,12,12,12h42
...
function WeatherThunderstorm({ size }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M6.34141 7C7.16508 4.66962 9.38756 3 12 3C15.3137 3 18 5.68629 18 9C20.2091 9 22 10.7909 22 13C22 14.8638 20.7252 16.4299 19 16.874M6.32069 7.04576C3.8806 7.37721 2 9.46898 2 12C2 14.0503 3.2341 15.8124 5 16.584" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 11.0002L9 16.0005L15 16.0001M15 16.0491L12 21.0493" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
const Icon = ({ name, size }) => {
  const icons = {
    ...
    wCloudy: WeatherCloudy,
    wFoggy: WeatherFoggy,
    wRainy: WeatherRainy,
    wSnowy: WeatherSnowy,
    wThunder: WeatherThunderstorm,
    add: AddIcon,
  };
